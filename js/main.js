...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.addEventListener('load', function () {
        // ...otros scripts existentes de tu proyecto aquí...
    
        // ✅ Optimización: solo activar parallax en pantallas grandes (no móviles)
        if (window.innerWidth > 768) {
            document.querySelectorAll('.mil-parallax').forEach(el => {
                gsap.to(el, {
                    yPercent: 20,
                    ease: 'none',
                    scrollTrigger: {
    ...
    if (window.innerWidth > 768) {
        ...
        gsapScript.src = 'path/to/gsap.min.js';
        gsapScript.onload = function() {
          const scrollScript = document.createElement('script');
          scrollScript.src = 'path/to/ScrollTrigger.min.js';
